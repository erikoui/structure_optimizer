...
class FrontendsBackend {
    constructor() {
        ...
        // TODO[Enhancement]: Allow the user to change material properties
        // according to the table at https://eurocodeapplied.com/design/en1992/concrete-design-properties
        this.modelDb.E = 30000*1000000;// according to EN1992-1-1 (γc = 1.50, fyk = 500 MPa)
        this.modelDb.G = this.modelDb.E/(2.4);// according to EN1992-1-1 §3.1
    ...
    //         }
    //         if (i1 && i2) {
    //             this.modelDb.FEmembers.push({ from: (i1), to: (i2), length:this.dist3d(this.modelDb.FEnodes[i1].coords,this.modelDb.FEnodes[2].coords) });
    //         }
    //     }
